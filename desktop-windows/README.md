# Mnote Windows 1.11.0-test

1.11.0：分享管理直接显示历史图片预览卡片，不用先点开；双击查看全部图片。新建与编辑记录可从“选择已有标签”下拉框添加标签，也可手写新增。读取当前账号已同步到本机的标签，不混用其他账号的标签。详见[本次说明](../docs/gallery-tags-1.11.0-release-notes.md)。
